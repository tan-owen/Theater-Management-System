...
/**
 * SupportStaff class extending User
 */
public class SupportStaff extends User {        
    public SupportStaff(String userID, String username, String passwordHash, String firstName, String lastName, String pronounce) {
